...
//        val deviceId = AESEncryption.getDeviceID(this)
//
//
//        val data = DeviceData()
//        try {
...
//            e.printStackTrace()
//        }
//        val deviceRequest = AESEncryption.encrypt(data)
//        val jwt = ""
//        println("MyApplication: $jwt -- $deviceRequest")
//        MealRepository.TOKEN = jwt
...
//        }
    ...
    companion object {
        ...
        fun initROAS(revenue: Long, currency: String) {
            try {
                val sharedPref =
                    android.preference.PreferenceManager.getDefaultSharedPreferences(instance)
